  ...
  watch: {
    $route(to, from) {
      ...
      this.enterActiveClass =
        "animate__animated animate__faster animate__fadeIn" + enterTransition;

      this.leaveActiveClass =
        "animate__animated animate__faster animate__fadeOut" + leaveTransition;
    }
  },
  methods: {
    ...
    animateScroll: function() {
      ...
      if (this.mobile == true) {
        ...
        $(".first__experience").removeClass("animate__delay-5s");
        $(".first__experience").addClass("animate__fadeIn");
      } else {
        // Trigger on ready but only fire for the first two element
        let i = 0;
        $(".scroll-animate.animate__animated").each(function() {
          if (scope.isScrolledIntoView(this) === true) {
